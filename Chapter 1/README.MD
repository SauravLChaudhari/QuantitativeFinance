This repository contains code that uses the yfinance library to analyze historical and real-time data for Reliance Industries Limited (RELIANCE.NS) stock.
